...
module.exports = function (options) {
  ...
  function action_putpost (si, args, done) {
    ...
    var good = _.filter(_.keys(data), function (k) {
      return !~k.indexOf('$')
    })
  ...
  function resolve (req, res, args, act, respond) {
    ...
    args.name = parts[ parts.length - 1 ] || mark
    args.base = parts[ parts.length - 2 ] || mark
    args.zone = parts[ parts.length - 3 ] || mark
