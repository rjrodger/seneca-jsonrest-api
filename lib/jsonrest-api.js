...
module.exports = function cart( options, register ) {
  ...
  var service = this.http({
    ...
    map:{
      ...
      put:{PUT:true,alias:':zone?/:base?/:name/:id?',data:true},
      post:{POST:true,alias:':zone?/:base?/:name/:id?',data:true},
  ...
  function make_user_access(entprop) {
    return function(args,done){
      ...
      if( user && user.access && ent ) {
        ...
        args.ctxt[entprop] = ent.make$(canon.zone,canon.base,canon.name)
      }
      done(null,args.ctxt)
    }
  }
